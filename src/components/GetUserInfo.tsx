...
const GetUserInfo = () => {
  ...
  const formSubmition = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    sendGAEvent("event", "buttonClicked", {
      value: "ads_conversion_Book_appointment_1",
    });
    ...
    <div className="absolute  w-full lg:w-4/5">
      <div className="relative p-6 rounded flex flex-col gap-6 justify-center items-center ">
        <Image
          ...
          src={"/firstForm.jpeg"}
          fill={true}
          className="-z-10 object-cover brightness-75 rounded-2xl"
        />
        ...
        >
          <div className="flex items-center  gap-4 flex-col md:flex-row">
            <input
              ...
              className="px-4 py-1 rounded w-[200px] focus:outline-none"
              value={name}
            ...
            />
            <select
              className="w-[210px] text-sm outline-none appearance-none text-start px-3 py-2 "
              value={serviceType}
              onChange={(e) => {
            ...
            >
              <option
                value="Air Duct & Ventilation Cleaning"
                className="focus:outline-none "
              >
                Air Duct & Ventilation Cleaning
              </option>
              <option
                value="Chimney Fireplaces Cleaning"
                className="focus:outline-none px-3 py-2"
              >
                Chimney Fireplaces Cleaning
              </option>
              <option
          ...
          <button className=" text-white bg-color-sidebar-secondary px-3 py-1 rounded-lg mt-6">
            Submit Now
          </button>
        </form>
      </div>
